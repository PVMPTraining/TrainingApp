...
export default function FoodScanner() {
				...
				Quagga.onProcessed((result : any) => {
					...
					if (result) {
						if (result.boxes) {
							...
							result.boxes.filter(function (box : any) { return box !== result.box; }).forEach(function (box : any) {
	...
	return (
		<>
			<div className='rounded-xl overflow-hidden [&>canvas]:hidden [&>br]:hidden' ref={scanner}>
			</div>
		</>
	);
}